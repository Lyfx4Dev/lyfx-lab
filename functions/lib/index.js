...
// ===========================
exports.indexadventuresToElastic = functions.firestore.document('/adventures/{adventureId}').onWrite((change, context) => {
...
// ===========================
exports.availabilityByAdventure = functions.firestore.document('/adventures/{adventureId}').onWrite((change, context) => {
...
// Another Functions
// ===========================
exports.adventuresCreatedAt = functions.firestore.document('adventures/{adventureId}').onCreate((snap, context) => {
